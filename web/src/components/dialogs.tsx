  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="dlg">
        ...
        <p><b>Free agent.</b> When no role is current you&apos;re a free agent. The day count in the Free agency row runs from your layoff event if you&apos;ve added one, otherwise from the end of your last role. Add a job-hunt event (<i>+ Add → Event</i>) as you apply and interview; the free-agent card and the timeline pick them up. Not looking? Turn free agency off under <i>Profile → Free agency</i> and the pack is just your cards.</p>
