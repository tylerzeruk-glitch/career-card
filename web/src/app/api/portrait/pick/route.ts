...
/** The chosen take becomes the card set: one PNG per team colour pair under the player's folder. The takes stay for a day, since they are the daily count. Returns the avatar address with a {pair} slot. */
